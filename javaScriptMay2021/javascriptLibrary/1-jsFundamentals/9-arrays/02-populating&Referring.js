...
// console.log(food);
// food.splice(1, 1, 'Bananas'); //asks for an insertion point, how many things to remove, then
...
food.forEach((food, index) => {
    console.log(food); //console.logs the value
    console.log(index); //console.logs the index number in the array 
})
