const presidents = [
   ...
   presidents.forEach((first, last) => {
       console.log(first);
       console.log(last);
   })

console.log(presidents[0].first, presidents[0].last)
...
//        // conditional                  ?              if-is-true-do-this                        : if-false-do-this
// };
